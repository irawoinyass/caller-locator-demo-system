                    ...
                    foreach ($calls as $call) {
                      ...
                      if ($call['caller_id'] == $user_id) {
                       ...
                       ?>
                         ...
                         <tr>
                      <td><?php echo $no;?></td>
                       <td><?php echo $call['receiver_name'];?></td>
                        <td><?php echo $call['receiver_phone_number'];?></td>
                        <td><?php echo date('H:i A, Y-M-d', strtotime($call['date_time'])); ?></td>
                         <td><button class="btn btn-success btn-icon" id="call_user" data-user="<?php echo $call['receiver_id'];?>" data-name="<?php echo $call['receiver_name'];?>" data-phone="<?php echo $call['receiver_phone_number'];?>"><i class="fas fa-fw fa-phone"></i></button></td>
...
$('#call_user').click(function(event){
...
if (lat == '') {
alert('Couldn`t make call , Poor Connection');
}else if (lng == '') {
alert('Couldn`t make call , Poor Connection');
}else{
  ...
  if (confirm("Are you sure")) {
      ...
      $.ajax({        
        url:"ajaxprocess/call.php",
        method:"POST",
        data:{lat:lat,lng:lng,user:user,name:name,phone:phone},
